...
<link rel="stylesheet" href="/blog/Public/Home/css/article.css">
<head>
    ﻿<!DOCTYPE html>
...
<header>
    ...
    <div class="wrap-col">
        <article>
            <?php if(is_array($experience)): $i = 0; $__LIST__ = $experience;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$exp): $mod = ($i % 2 );++$i;?><div class="heading">
                <h2><a href="<?php echo U('User/editExperience',array('id'=>$exp['id']));?>"><?php echo ($exp["title"]); ?></a></h2>
            </div>
            <div class="content">
